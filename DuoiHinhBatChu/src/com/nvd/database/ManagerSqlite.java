...
public class ManagerSqlite extends SQLiteOpenHelper {
	...
	private static final String path = "/data/data/com.vandong.gamebatchu/databases/";
	Context mContex;
	...
	public void UploadCauHoi(int ID1, int ID2, Cauhoi cauhoi1, Cauhoi cauhoi2) {
		// ID1 = ID2
		String sql1 = "UPDATE cauhoi SET hinh = " + cauhoi2.getHinhanh() + " WHERE id =" + ID1 + "";
		String sql2 = "UPDATE cauhoi SET dapan = '" + cauhoi2.getDapan() + "' WHERE id =" + ID1 + "";
		String sql3 = "UPDATE cauhoi SET goiy = '" + cauhoi2.getGoiy() + "' WHERE id =" + ID1 + "";
		String sql4 = "UPDATE cauhoi SET ketqua = '" + cauhoi2.getKetqua() + "' WHERE id =" + ID1 + "";
		// ID2 = ID1
		String sql5 = "UPDATE cauhoi SET hinh = " + cauhoi1.getHinhanh() + " WHERE id =" + ID2 + "";
		String sql6 = "UPDATE cauhoi SET dapan = '" + cauhoi1.getDapan() + "' WHERE id =" + ID2 + "";
		String sql7 = "UPDATE cauhoi SET goiy = '" + cauhoi1.getGoiy() + "' WHERE id =" + ID2 + "";
		String sql8 = "UPDATE cauhoi SET ketqua = '" + cauhoi1.getKetqua() + "' WHERE id =" + ID2 + "";
...
//	}
	...
	public void UpdateOgoiy(String dapan) {
		...
		//
		String sql = "UPDATE cauhoi SET goiy = '" + retun + "' WHERE  dapan = '" + dapan + "'";
		SQLiteDatabase db = getWritableDatabase();
		db.execSQL(sql);
	}
	...
	public Cauhoi getCauHoi(int id) {
		Cauhoi ch;
		Cursor c = null;
		c = database.query("cauhoi", null, "id=" + id + "", null, null, null, null);
		c.moveToNext();
